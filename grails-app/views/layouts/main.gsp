        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#dashboard">
                	<img class="google_logo" alt="GLab" src="http://www.w3schools.com/css/img_trans.gif">
               	</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="#devices">Broken</a>
                                </li>
                                <li>
                                    <a href="#devices">Lost</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="#sendreminder">Send a reminder</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
